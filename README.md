...
We provide a pre-trained weights file named **`mask2former_wound_segmentation_fold0.pth`**. This model was trained using folds 2,3 and 4 of the 4-fold cross-validation workflow described in our paper. 
